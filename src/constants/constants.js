...
export const TimeLineData = [
    ...
    {year:2023, text:"Start working in a company and continue learning"},
    {year:2024, text:"Still working in a company and continue learning and working freelance"},
];
